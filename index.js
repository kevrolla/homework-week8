...
function init() {
  inquirer
    ...
    .then(function ({ username, color }) {
      ...
      axios //axios call to get the username, repositories etc from github
        .get(queryUrl)
        .then((res) => {
          ...
          data.profilePic = res.data.avatar_url;
...
<html lang="en">
   <head>
      ...
      <div class="links-nav">
      <a class="nav-link" target="_blank" href="https://www.google.com/maps/place/${data.location.split(' ')[0]}+${data.location.split(' ')[1]}">${data.location}</a>
